...
export default function GuiaDeUsoPage() {
    ...
    const [activeSection, setActiveSection] = useState("instalar-movil")
    ...
    // Observar secciones visibles para actualizar sidebar (scroll-spy)
    useEffect(() => {
        // Esperar a que el contenedor esté montado
        const root = contentRef.current
        if (!root) return

        const sectionElements = root.querySelectorAll("[data-section]")
        ...
        const observer = new IntersectionObserver(
            (entries) => {
                ...
                // Activar la primera sección visible según orden del DOM
