...
export default function CanvasToolbar({
    ...
    return (
        <div className="flex items-center justify-between border-b bg-background px-3 py-2">
            ...
            {/* Right: word count + actions + title */}
            <div className="flex items-center gap-1">
                {/* Word count */}
                {wordCount != null && wordCount > 0 && (
                    <>
                        <span className="hidden text-[11px] text-muted-foreground sm:block pr-1">
                ...
                {/* "Lienzo" label — desktop only */}
                <Badge variant="outline" className="hidden text-[10px] md:flex">
                    {t("title")}
                </Badge>
