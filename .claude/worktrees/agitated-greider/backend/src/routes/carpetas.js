...
// Helper: acceso a carpetas (disponible para todos los usuarios autenticados)
function isPro(user) {
    return true; // Carpetas disponibles para todos los usuarios
}
...
router.post('/:id/compartir', async (req, res) => {
    try {
        ...
        // Se puede compartir con cualquier usuario registrado
